...
function log() {
  return (
    <div className="Log">
      <Header />
      <>
        NUESSとは，Nara University of Education Searchable Syllabus(奈良教育大学 検索できるシラバス)の略です。
      </>
      <Table striped responsive>
        ...
        <tbody>
          <tr>
            ...
            <td>履修管理機能</td>
            <td>履修管理機能を搭載。GPAの計算も可能。
            </td>
          </tr>
          <tr>
            <th scope="row">2026/3/24</th>
            <td>デザイン</td>
            <td>一部デザインを変更。
            </td>
          </tr>
          ...
          <tr>
            <th scope="row">2025/3/26</th>
            <td>検索機能</td>
            <td>教育学研究科を修士課程に修正。<br/>専門職学位課程と修士課程のチェックボックスの順序を変更。
            </td>
          </tr>
          <tr>
            <th scope="row">2025/3/26</th>
            <td>ページネーション</td>
            <td>ページネーションするか否かを選択できるように変更。
            </td>
          </tr>
          <tr>
            <th scope="row">2025/3/12</th>
            <td>シラバス</td>
            <td>データを2025年度(2025/3/12時点)のものに更新。
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>ページデザインを抜本的に変更。<br /> ＜詳細な変更点＞
              <br /> シラバスデータを2022年度(2022/3/27時点)のものに更新。
