        ...
        <Navbar className="header_style" variant="dark" fixed="top" expand="md">
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="me-auto">
                    ...
                    <Nav.Link href="https://www.nara-edu.ac.jp/ADMIN/KYOUMU/SYLLABUS/syllabus/2023/KmkkbnIchiran_0_0.html" target="_blank" rel='noopener noreferrer'>奈良教育大学シラバス</Nav.Link>
                    ...
                    <Nav.Link href="https://forms.gle/zuWR5FvHrEC55ejSA" target="_blank" rel='noopener noreferrer'>利用者アンケート</Nav.Link>
                </Nav>
            </Navbar.Collapse>
        </Navbar>
    );
