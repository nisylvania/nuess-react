...
const SearchGraduate = ({ tt_num, setTt_num, subject_name, setSubject_name, teacher_name, setTeacher_name, semester_option, setSemester, period_option, setPeriod, sdgs_option, setSdgs, autoOn, setAutoState, self_search, reset, room_name, setRoom_name }) => {
